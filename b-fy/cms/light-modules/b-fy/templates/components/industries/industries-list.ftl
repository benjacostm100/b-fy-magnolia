...
<#macro industriesList>
  ...
  <#assign defaultItems = [
    { "title":"Transport & Logistics", "tagline":"Security and efficiency across all your operations", "description":"Secure access across your logistics chain — terminals, service stations, warehouses, and delivery hubs. B-FY's decentralized biometric solution ensures agile and secure authentication of drivers, staff, and clients, eliminating impersonation risks while streamlining operations.", "image":"transport-logistics.webp", "link":"/industries/transport-logistics" },
